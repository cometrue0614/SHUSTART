            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="service-wrapper">
                        <a href="../admin/discover/music_article_list.php">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="service-wrapper">
                        <a href="../admin/discover/art_article_list.php">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="service-wrapper">
                        <a href="../admin/discover/photograph_article_list.php">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="service-wrapper">
                        <a href="../admin/discover/technology_article_list.php">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="service-wrapper">
                        <a href="../admin/discover/film_article_list.php">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="service-wrapper">
                        <a href="../admin/discover/publishing_article_list.php">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="service-wrapper">
                        <a href="../admin/discover/design_article_list.php">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="service-wrapper">
                        <a href="../admin/discover/game_article_list.php">
