                        ...
                        <div class="mainmenu-submenu-inner">
                          <div>
                            ...
                            <div>
                                ...
                                <ul>
                                    <li>
                                        <a href="rtf_works_list.php">廣電系</a>
                                    </li>
                                    <li>
                                        <a href="news_works_list.php">新聞系</a>
                                    </li>
                                    <li>
                                        <a href="pc_works_list.php">公廣系</a>
                                    </li>
                                    <li>
                                        <a href="gcdp_works_list.php">圖傳系</a>
                                    </li>
                                    <li>
                                        <a href="ic_works_list.php">資傳系</a>
                                    </li>
                                    <li>
                                        <a href="speech_works_list.php">口傳系</a>
                                    </li>
                                    <li>
                                        <a href="cm_works_list.php">傳管系</a>
                                    </li>
                                    <li>
                                        <a href="dma_works_list.php">數媒系</a>
                                    </li>
                                    <li>
                                        <a href="im_works_list.php">資管系</a>
                                    </li>
                                    <li>
                                        <a href="ba_works_list.php">企管系</a>
                                    </li>
                                    <li>
                                        <a href="tourism_works_list.php">觀光系</a>
                                    </li>
                                    <li>
                                        <a href="eng_works_list.php">英語系</a>
                                    </li>
                                    <li>
                                        <a href="jpn_works_list.php">日文系</a>
                                    </li>
                                </ul>
                            </div>
                            <div>
