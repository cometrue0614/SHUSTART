...
$datass = get_user();
$article = get_game_article($_GET['p']);
?>
            ...
            <div class="container">
                <div class="row">
					...
					<h5>
						...
						<center><div class="fb-comments" data-href="http://www.shumis.url.tw/shustart/admin/game_article.php" data-width="500" data-numposts="5"></div></center>
					</div>
                </div>
            </div>
        </div>
