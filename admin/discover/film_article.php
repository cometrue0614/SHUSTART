...
$datass = get_user();
$article = get_film_article($_GET['p']);
?>
            ...
            <div class="container">
                <div class="row">
					...
					<h5>
						...
						<center><div class="fb-comments" data-href="http://www.shumis.url.tw/shustart/admin/film_article.php" data-width="500" data-numposts="5"></div></center>
					</div>
                </div>
            </div>
        </div>
