        ...
        <div class="section">
            <div class="container">
                <div class="row add_btn_area">
                    <div class="col-xs-12">
                        <a href="article_add.php" class="btn btn-primary">新增點評</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <table class="table table-hover" id="list">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="article_edit.php?i=<?php echo $a_data['id'];?>" class="btn btn-green">編輯</a>
                                    <a href="javascript:void(0);" class="btn btn-orange del_article" data-id="<?php echo $a_data['id'];?>">刪除</a>
                                </td>
                            </tr>
                            <?php endforeach;?>
                            <?php else:?>
